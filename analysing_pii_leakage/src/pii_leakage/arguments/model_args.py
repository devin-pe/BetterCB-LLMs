...
class ModelArgs:
    ...
    # Intervention configuration for concept bottleneck models
    concept_intervention: str = field(default="none", metadata={
        "help": "Concept intervention strategy used by CBLLM wrappers (default: 'none')"
    })
